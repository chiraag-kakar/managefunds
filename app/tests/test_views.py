...
from app.models import Fund, Category, Expense
import json
...
class TestViews(TestCase):
    def setUp(self):
        ...
        self.project1 = Fund.objects.create(
            name='project1',
            budget=1000,
    ...
    def test_project_list_GET(self):
        ...
        self.assertTemplateUsed(response, 'app/project-list.html')

    def test_project_detail_GET(self):
        response=self.client.get(self.detail_url)
        self.assertEquals(response.status_code,200)

        self.assertTemplateUsed(response,'app/project-detail.html')
    ...
    def test_project_create_POST(self):
        ...
        project2=Fund.objects.get(id=2)
