...
from .models import Fund, Category, Expense
...
def project_detail(request, project_slug):
    ...
    if request.method == 'GET':
        ...
        return render(request, 'app/project-detail.html', {'project': project, 'expense_list': project.expenses.all(), 'category_list': category_list})
